          ...
          <div className="card-body border-bottom pb-0">
            ...
            >
              <li className="nav-item">
                <button
                  className={`nav-link fw-semibold px-4 py-2 rounded-pill ${activeTab === "challan"
                    ? "active bg-primary text-white shadow-sm"
                    : "text-primary border border-primary bg-transparent"
                    }`}
                  onClick={() => handleTabClick("challan")}
                >
              ...
              <li className="nav-item">
                <button
                  className={`nav-link fw-semibold px-4 py-2 rounded-pill ${activeTab === "invoice"
                    ? "active bg-primary text-white shadow-sm"
                    : "text-primary border border-primary bg-transparent"
                    }`}
                          ...
                          {pageLoading ? (
                            ...
                            purchaseData.map((purchase, index) => (
                              <tr key={purchase?.purchase_id || index}>
                                ...
                                <td>{purchase?.challan_no || "N/A"}</td>
                                <td>
                                  {purchase?.challan_date
                                    ? new Date(purchase.challan_date)
